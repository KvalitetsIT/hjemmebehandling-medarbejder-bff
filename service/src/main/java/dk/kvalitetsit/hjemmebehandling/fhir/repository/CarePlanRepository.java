...
public interface CarePlanRepository<CarePlan, Patient> extends Repository<CarePlan, QualifiedId.CarePlanId> {
     ...
     */
    QualifiedId.CarePlanId save(CarePlan carePlan, Patient patient) throws ServiceException;
