...
public class ConcretePatientRepository implements PatientRepository<Patient, CarePlan.CarePlanStatus> {
    ...
    @Override
    public String save(Patient patient) throws ServiceException {
        return client.saveResource(patient);
    }

    @Override
    public Optional<Patient> fetch(QualifiedId id) throws ServiceException {
        throw new NotImplementedException();
    }

    @Override
    public List<Patient> fetch(List<QualifiedId> id) throws ServiceException {
        throw new NotImplementedException();
    }
