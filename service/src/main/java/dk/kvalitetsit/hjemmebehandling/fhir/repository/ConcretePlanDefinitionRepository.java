...
public class ConcretePlanDefinitionRepository implements PlanDefinitionRepository<PlanDefinition> {
    ...
    @Override
    public List<PlanDefinition> fetchActivePlanDefinitionsUsingQuestionnaireWithId(QualifiedId questionnaireId) throws ServiceException {
    ...
    @Override
    public String save(PlanDefinition resource) throws ServiceException {
        return client.saveResource(resource);
    }

    @Override
    public Optional<PlanDefinition> fetch(QualifiedId id) throws ServiceException {
    ...
    @Override
    public List<PlanDefinition> fetch(List<QualifiedId> ids) throws ServiceException {
    ...
    private FhirLookupResult getPlanDefinitionsById(List<QualifiedId> ids) {
